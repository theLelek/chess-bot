...
public class PseudoLegalMoveFinderTest {
    ...
    public void testFindLegalPawnMoves() {
        ...
        List<Move> actual = PseudoLegalMoveFinder.getLegalPawnMoves(board, new BoardPosition(4,3));
    ...
    public void testFindLegalPawnMoves2() {
        ...
        List<Move> actual = PseudoLegalMoveFinder.getLegalPawnMoves(board, new BoardPosition(7, 1));

...
public class PseudoLegalMoveFinderTest {
    ...
    public void testFindLegalMoves1() {
        ...
        List<Move> actual = getMovesFromStartingPosition(board.getPseudoLegalMovesBlack(), new BoardPosition(5, 0));
    ...
    public void testFindLegalPawnMoves() {
        ...
        board.calculateLegalMoves();
        List<Move> actual = getMovesFromStartingPosition(board.getPseudoLegalMovesWhite(), new BoardPosition(4, 3));
    ...
    public void testFindLegalPawnMoves2() {
        ...
        board.calculateLegalMoves();
        List<Move> actual = getMovesFromStartingPosition(board.getPseudoLegalMovesBlack(), new BoardPosition(7, 1));

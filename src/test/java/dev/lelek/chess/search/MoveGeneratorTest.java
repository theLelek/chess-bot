...
class MoveGeneratorTest {
    ...
    void generateMove_captureQueenWhileInCheck() {
        Board board = Fen.fromFen("K6k/8/8/8/8/8/8/3q3Q b - - 0 1");
    ...
    void generateMove_checkmate() {
        Board board = Fen.fromFen("1k6/1Q5R/8/8/8/8/8/K7 b - - 3 2");
    ...
    void generateMove_mateIn1ByQueen() {
        Board board = Fen.fromFen("1k6/8/8/8/4Q3/8/8/K6B w - - 3 2");
        Move bestMove = MoveGenerator.generateMove(board, 2);
    ...
    void generateMove_mateIn1ByRook() {
        Board board = Fen.fromFen("1k6/7R/8/8/8/8/8/K4R2 w - - 3 2");
        Move bestMove = MoveGenerator.generateMove(board, 2);
    ...
    void generateMove_mateIn2() {
        Board board = Fen.fromFen("3qr2k/pbpp2pp/1p5N/3Q2b1/2P1P3/P7/1PP2PPP/R4RK1 w - - 1 2");
    ...
    void generateMove_GameEndsInMate() {
        Board board = Fen.fromFen("8/8/8/8/1q6/8/2k5/K7 w - - 0 1");
        Move bestMove = MoveGenerator.generateMove(board, 4);

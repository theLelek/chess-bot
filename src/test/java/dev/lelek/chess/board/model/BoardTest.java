...
class BoardTest {
    ...
    void move_italienLine() {
        ...
        Board beforeMove7 = Board.initializeFromFen("r1bqk1nr/pppp1ppp/2n5/2b1p3/2B1P3/5N2/PPPP1PPP/RNBQK2R w KQkq - 4 4");
    ...
    void move_castle() {
        ...
        Board originalBoard2 = Board.initializeFromFen("4k3/8/8/8/8/8/8/R3K2R w KQ - 0 1");
        Board board2 = Board.initializeFromFen("4k3/8/8/8/8/8/8/R3K2R w KQ - 0 1");
        Move move2 = new CastlingMove("e1", "c1");
        board2.makeMove(move2);
        assertEquals(Board.initializeFromFen("4k3/8/8/8/8/8/8/2KR3R b - - 1 1"), board2);
        ...
        Board originalBoard3 = Board.initializeFromFen("r3k2r/8/8/8/8/8/8/4K3 b kq - 0 1");
        Board board3 = Board.initializeFromFen("r3k2r/8/8/8/8/8/8/4K3 b kq - 0 1");
        Move move3 = new CastlingMove("e8", "g8");
        board3.makeMove(move3);
        assertEquals(Board.initializeFromFen("r4rk1/8/8/8/8/8/8/4K3 w - - 1 2"), board3);
        ...
        Board originalBoard4 = Board.initializeFromFen("r3k2r/8/8/8/8/8/8/4K3 b kq - 0 1");
        Board board4 = Board.initializeFromFen("r3k2r/8/8/8/8/8/8/4K3 b kq - 0 1");
        Move move4 = new CastlingMove("e8", "c8");
        board4.makeMove(move4);
        assertEquals(Board.initializeFromFen("2kr3r/8/8/8/8/8/8/4K3 w - - 1 2"), board4);
    ...
    void move_promotion() {
        ...
        assertEquals(Board.initializeFromFen("8/P7/8/8/8/8/8/k6K w - - 0 1"), board1);
        ...
        assertEquals(Board.initializeFromFen("4r3/5P2/8/8/8/8/8/k6K w - - 0 1"), board2);
        ...
        assertEquals(Board.initializeFromFen("3r4/8/8/3k4/8/6K1/3p4/R7 b - - 0 1"), board3);
        ...
        assertEquals(Board.initializeFromFen("3r4/8/8/3k4/8/8/3p4/RKBn4 b - - 0 2"), board4);

...
class ZobristTest {
    ...
    void fromBoard_WhenEnPassantCaptureIsAvailable() {
        Board board1 = Fen.fromFen("rnbqkbnr/ppp1pppp/8/8/3pP3/8/PPPP1PPP/RNBQKBNR b KQkq - 0 1");
        Board board2 = Fen.fromFen("rnbqkbnr/ppp1pppp/8/8/3pP3/8/PPPP1PPP/RNBQKBNR b KQkq e3 0 1");
        Assertions.assertNotEquals(Zobrist.fromBoard(board1), Zobrist.fromBoard(board2));

        Board board3 = Fen.fromFen("rnbqkbnr/ppppp1pp/8/8/4Pp2/8/PPPP1PPP/RNBQKBNR b KQkq - 0 1");
        Board board4 = Fen.fromFen("rnbqkbnr/ppppp1pp/8/8/4Pp2/8/PPPP1PPP/RNBQKBNR b KQkq e3 0 1");
    ...
    void fromBoard_WhenEnPassantCaptureIsNotAvailable() {
        Board board1 = Fen.fromFen("r1bqkbnr/pppppppp/2n5/8/4P3/8/PPPP1PPP/RNBQKBNR b KQkq - 0 1");
        Board board2 = Fen.fromFen("r1bqkbnr/pppppppp/2n5/8/4P3/8/PPPP1PPP/RNBQKBNR b KQkq - 0 1");

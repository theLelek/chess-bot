...
class PawnStructureTest {
    ...
    void getPassedPawnValue_White() {
        Board board1 = Fen.fromFen("7k/8/8/8/1P6/8/8/7K w - - 0 1");
        ...
        Board board6 = Fen.fromFen("7k/4r3/8/8/Pp6/8/8/7K w - - 0 1");
        ...
        Board board7 = Fen.fromFen("7k/1p2r3/8/8/P7/8/8/7K w - - 0 1");
    ...
    void getPassedPawnValue_Black() {
        ...
        Board board3 = Fen.fromFen("7k/1p2r3/8/8/4P3/8/8/1Q5K w - - 0 1");
        ...
        Board board4 = Fen.fromFen("7k/p3r3/8/8/4P3/8/8/1Q5K w - - 0 1");
